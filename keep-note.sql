...
remainder_id int(5) primary key,
remainder_name varchar(30),
remainder_descr varchar(50),
remainder_type varchar(15),
remainder_creation_date date,
remainder_creator varchar(15));
...
insert into NoteRemainder values(101,001,1000);
insert into NoteRemainder values(102,002,1001);
insert into NoteRemainder values(103,003,1002);
insert into NoteRemainder values(104,004,1003);
insert into NoteRemainder values(105,005,1004);

insert into Remainder values(1000,'Java_rem','Java8 Remainder','daily','2019-11-04','Sun');
insert into Remainder values(1001,'HTML_rem','HTML&CSS Remainder','weekly','2019-11-11','Amith');
insert into Remainder values(1002,'JS_rem','JS Remainder','twodays','2019-11-20','Arundathi');
insert into Remainder values(1003,'Angular_rem','Angular Remainder','biweekly','2019-12-10','Google');
insert into Remainder values(1004,'Spring_rem','Spring Boot Remainder','monthly','2019-12-16','Arun');
...
select * from Remainder,NoteRemainder where NoteRemainder.remainder_id=Remainder.remainder_id and NoteRemainder.note_id=005;
select * from Remainder where remainder_id=001;
...
Delete nr from NoteRemainder nr where nr.note_id = old.note_id;
